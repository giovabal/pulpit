...
- **Channel name links to detail page in manage** — in the backoffice channels list (`/manage/channels/`), each channel's name is now a clickable link to its detail page on the main site.
