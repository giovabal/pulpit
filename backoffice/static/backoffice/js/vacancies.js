(function() {
    ...
    function renderRow(vac, editing) {
        ...
        if (editing) {
            ...
            tdCh.appendChild(chPicker.wrap);
            tr.appendChild(tdCh);

            var tdDate = document.createElement("td");
            var dateInput = document.createElement("input");
            dateInput.className = "bo-input";
            dateInput.type = "date";
            dateInput.value = vac.closure_date || "";
            ...
            tdSucc.appendChild(succPicker.wrap);
            ...
            var tdChd = document.createElement("td");
            tdChd.textContent = vac.channel_title || "";
            tr.appendChild(tdChd);
            var tdDd = document.createElement("td");
            tdDd.textContent = vac.closure_date || "";
            tr.appendChild(tdDd);
            var tdSd = document.createElement("td");
            tdSd.textContent = vac.successor_title || "—";
            tr.appendChild(tdSd);
            var tdNd = document.createElement("td");
            tdNd.className = "text-muted";
            tdNd.style.fontSize = ".875rem";
            tdNd.textContent = vac.note || "";
            tr.appendChild(tdNd);
