(function() {
    ...
    function _buildPicModal() {
        ...
        $picModalEl.className = "modal fade";
        $picModalEl.tabIndex = -1;
        $picModalEl.setAttribute("aria-hidden", "true");
    ...
    function render(ch, labels, labelGroups, channelSources) {
        ...
        header.className = "bo-ch-update-header";
        var back = document.createElement("a");
        back.href = "/manage/channels/";
        back.className = "bo-btn bo-btn--ghost bo-btn--sm";
        back.innerHTML = '<i class="bi bi-arrow-left me-1"></i>Channels';
        header.appendChild(back);

        var titleWrap = document.createElement("div");
        titleWrap.className = "bo-ch-update-title";
        var pic = makeProfilePicEl(ch, "bo-ch-update-pic bo-ch-pic--clickable");
        if (pic) {
            var picWrap = document.createElement("div");
            picWrap.className = "bo-ch-update-pic-wrap";
        ...
        h2.className = "bo-ch-update-name";
        ...
        info.className = "bo-ch-update-info";
        [
            ...
            cell.className = "bo-info-cell";
            var lbl = document.createElement("div");
            lbl.className = "bo-info-label";
            lbl.textContent = pair[0];
            var val = document.createElement("div");
            val.className = "bo-info-value";
        ...
        form.className = "bo-ch-update-form";
        ...
        function addLabelRow(rowsWrap, group, channelLabel) {
            ...
            sel.className = "bo-select bo-period-label";
            ...
            start.type = "date";
            start.className = "bo-input bo-period-start";
            ...
            end.className = "bo-input bo-period-end";
            if (channelLabel && channelLabel.end) end.value = channelLabel.end;
            var rm = document.createElement("button");
            rm.type = "button";
            rm.className = "bo-btn bo-btn--ghost bo-btn--sm";
        ...
        labelGroups.forEach(function(group) {
            ...
            section.className = "bo-label-group-section mb-3";
            ...
            addBtn.type = "button";
            addBtn.className = "bo-btn bo-btn--ghost bo-btn--sm";
        ...
        srcWrap.className = "bo-ch-update-sources";
        channelSources.forEach(function(s) {
            var lbl = document.createElement("label");
            lbl.className = "bo-check-label";
        ...
        fgSrc.appendChild(srcWrap);
        form.appendChild(fgSrc);

        /* Flags */
        var fgFlags = makeFieldGroup("Flags");
        var flagsWrap = document.createElement("div");
        flagsWrap.className = "d-flex gap-4";
        [
            ["is_lost", "Lost"],
            ["is_private", "Private"]
        ].forEach(function(pair) {
        ...
        fgFlags.appendChild(flagsWrap);
        form.appendChild(fgFlags);

        /* To-inspect */
        var fgInspect = makeFieldGroup("Inspect");
        var inspectWrap = document.createElement("label");
        inspectWrap.className = "bo-check-label";
        var chkInspect = document.createElement("input");
        chkInspect.type = "checkbox";
        chkInspect.name = "to_inspect";
        ...
        fgInspect.appendChild(inspectWrap);
        form.appendChild(fgInspect);

        /* Buttons */
        var btnRow = document.createElement("div");
        btnRow.className = "bo-ch-update-btns";
        var saveBtn = document.createElement("button");
        saveBtn.type = "submit";
        saveBtn.className = "bo-btn";
        saveBtn.innerHTML = '<i class="bi bi-check me-1"></i>Save';
        var cancelBtn = document.createElement("a");
        cancelBtn.href = "/manage/channels/";
        cancelBtn.className = "bo-btn bo-btn--ghost";
    ...
    function makeFieldGroup(label) {
        ...
        fg.className = "bo-field-group";
        var lbl = document.createElement("label");
        lbl.className = "bo-field-label";
    ...
    function validateLabels(rows) {
        ...
        for (var a = 0; a < rows.length; a++) {
            ...
            for (var b = a + 1; b < rows.length; b++) {
                ...
                var s1 = rows[a].start || LO,
                    e1 = rows[a].end || HI;
                var s2 = rows[b].start || LO,
                    e2 = rows[b].end || HI;
