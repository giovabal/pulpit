...
SA_ROBUSTNESS_NULL_MODEL = _structural.robustness.null_model
SA_ROBUSTNESS_SEED = _structural.robustness.seed
SA_ROBUSTNESS_SAMPLE = _structural.robustness.sample
SA_ROBUSTNESS_ALPHA_GRID = ",".join(str(a) for a in _structural.robustness.alpha_grid)
SA_ROBUSTNESS_REPLAY = _structural.robustness.replay
...
SA_COORDINATION_2D = _structural.coordination.map_2d
SA_COORDINATION_3D = _structural.coordination.map_3d
