...
class OperationsView(View):
    def get(self, request: HttpRequest) -> HttpResponse:
        ...
        ad = {
            ...
            "SA_COORDINATION_2D": settings.SA_COORDINATION_2D,
            "SA_COORDINATION_3D": settings.SA_COORDINATION_3D,
...
TASK_DEFAULT_SPECS: dict[str, list[tuple]] = {
    ...
    "structural_analysis": [
        ...
        ("coordination_2d", "coordination.map_2d", "bool"),
        ("coordination_3d", "coordination.map_3d", "bool"),
